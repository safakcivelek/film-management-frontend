...
// import React, { useRef } from 'react';
// import { useParams } from 'react-router-dom';
// import { CardMedia, Typography, Box, Grid, Button, Container } from '@mui/material';
// import PlayArrowIcon from '@mui/icons-material/PlayArrow';
// import ShoppingCartIcon from '@mui/icons-material/ShoppingCart';
// import EventAvailableIcon from '@mui/icons-material/EventAvailable';
// import AccessTimeIcon from '@mui/icons-material/AccessTime';
// import StarIcon from '@mui/icons-material/Star';
// import fakeFilms from '../../data/fakeFilms'; // fakeFilms verilerini import edin
...
//             opacity: 0.4, // Opaklığı düşürerek daha şeffaf hale getirdik
//             zIndex: -1,
//           }
//         }}
//       >
...
//                     image={film.image}
//                     alt={film.title}
//                     sx={{ width: { xs: '100%', md: 410 }, height: { xs: 'auto', md: 560 }, objectFit: 'cover', borderRadius: 2 }}
//                   />
//                 </Grid>
//                 <Grid item xs={12} md={7} sx={{ display: 'flex', alignItems: 'center', mt: 4 }}>
//                   <Box sx={{ display: 'flex', flexDirection: 'column', justifyContent: 'center', height: '100%', color: 'white' }}>
//                     <Typography variant="h3" component="div" sx={{ mb: 6, fontWeight: 'bold' }}>
//                       {film.title}
//                     </Typography>
//                     <Grid container spacing={2} sx={{ mb: 3 }} alignItems="center">
...
//       </Box>
//       <Container maxWidth="lg" sx={{ py: 4 }}>
//         <Box ref={videoRef} sx={{ p: 3, backgroundColor: '#1E1F29', color: 'white', borderRadius: 2 }}>
//           <Typography variant="h5" component="div" sx={{ mb: 2 }}>
//             Filmi İzle
//           </Typography>
